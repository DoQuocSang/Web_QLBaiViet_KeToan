                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Tên loại:</label>
                                        <div class="col-sm-10"><input name="category_post_name" type="text" class="form-control" placeholder="Nhập tên loại"></div>
                                    </div>
                                    ...
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Mô tả:</label>
                                        <div class="col-sm-10"><textarea name="category_post_desc" rows="3" class="form-control" placeholder="Nhập mô tả"></textarea></div>
                                    </div>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Ngày tạo</label>
                                        <div class="input-group date col-sm-10">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input name="category_post_date_create" type="text" class="form-control" value="07/01/2014">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Trạng thái:</label>
                                        <div class="col-sm-10">
                                                <select name="category_post_status" class="form-control m-b" name="account">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <button class="btn btn-primary btn-sm" type="submit" name="add_category_post">Lưu thay đổi</button>
                                    </div>
                                </div>
                                </fieldset>
                            </form>
