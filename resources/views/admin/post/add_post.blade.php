                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            ...
                            <div class="panel-body">
                                <form action={{ URL::to('/save-post-detail') }} method="POST">
                                    {{ csrf_field() }}
                                    <fieldset>
                                        <div class="form-group row"><label class="col-sm-2 col-form-label">Số thứ tự:</label>
                                            <div class="col-sm-10"><input name="post_index" type="number"
                                        ...
                                        <div class="form-group row"><label class="col-sm-2 col-form-label">Tiêu đề:</label>
                                            <div class="col-sm-10"><input name="post_title" type="text"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 col-sm-offset-2">
                                                ...
                                                <button class="btn btn-primary btn-sm" type="submit" name="add_post">Lưu thay đổi</button>
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
