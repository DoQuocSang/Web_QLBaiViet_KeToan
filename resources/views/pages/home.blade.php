...
@section('content')
        ...
        <div class="container">
                ...
                <div class="col-12 col-md-4 mb-3 mb-md-0">
                    <div class="card card-hover--shadow p-3 p-md-2 p-lg-4 rounded--none h-100">
                        ...
                        <p class="font-size--15">No matter what device it is. Each of our themes is natively responsive,
                            resizing your content and images to fit any device or screen width. You can also adjust them in
                            your way.</p>
                    </div>
                </div>
                <!-- end of col -->
                <div class="col-12 col-md-4 mb-3 mb-md-0">
                    <div class="card card-hover--shadow p-3 p-md-2 p-lg-4 rounded--none h-100">
                        ...
                        <p class="font-size--15">We have thousands of font options included our custom fonts as well as all
                            google fonts. We also have custom icon packs along with icon fonts like font awesome and
                            icofont.</p>
                    </div>
                </div>
                <!-- end of col -->
                <div class="col-12 col-md-4 mb-3 mb-md-0">
                    <div class="card card-hover--shadow p-3 p-md-2 p-lg-4 rounded--none h-100">
                        ...
                        <p class="font-size--15">Security on the web was never been easy. SpaceMax protects your data with
                            one of the most advanced encryptions. You never need to worry about security. We will handle
            ...
            <div class="row card--v1 flex-column-reverse flex-md-row">
                <div class="col-12 col-md-8 mb-3 mb-md-0">
                    <div
                        class="card p-3 p-md-2 p-lg-4 pr-lg-10 rounded--none h-100 align-items-start justify-content-center">
                        <span class="mb-1 text-color--400">No coding skill? No problem!</span>
                        <h3 class="font-size--26 mb-2">Our platform is fully automated and we have thousands of options for
                            each industry.</h3>
                        <p class="font-size--15 mb-4">You will never be disappointed at SpaceMax. SpaceMax has a huge
                            template library for each and every industry. Our every single template has everything that you
                            will need for your business. Every template of SpaceMax is unique
                            with a great UX which will help you to grow up your business.</p>
                        <a href="#" class="btn btn-size--md btn-bg--dark btn-hover--primary rounded--none"><span
                                class="btn__text font-w--500">See Our Templates</span></a>
                    </div>
                </div>
                <!-- end of col -->
                <div class="col-12 col-md-4 mb-3 mb-md-0">
                    <div class="card card-hover--shadow p-3 p-md-2 p-lg-4 rounded--none h-100">
                        ...
                        <p class="font-size--15">Each of our themes is natively supported e-commerce features. The
                            integration is super simple. There are also hundreds of plugins available on our platform for
                            e-commerce.</p>
                    </div>
                </div>
                <!-- end of col -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-10 col-lg-5 mx-auto text-center text-lg-left mb-5 reveal">
                    ...
                    <p class="mb-4">Represent your business or ideas in a most beautiful way with our themes. All of our
                        themes are designed and developed by world top designer and developer and every piece of work is
                        unique and made with care.</p>
                    <a href="#"
                        class="btn btn-size--md rounded--none btn-border btn-border--color--dark text-color--700 btn-hover--primary">
            ...
            <div class="row">
                <div class="col-12 col-sm-9 col-lg-7 col-xl-6 mb-5 mb-lg-8 mx-auto text-center reveal">
                    <div class="section-title">
                        ...
                        <p class="mb-4">Over a million companies use SpaceMax to make their dream website concepts come
                            visible. See some examples below.</p>
                        <a href="#"
                            class="btn btn-size--md rounded--none btn-border btn-border--color--dark text-color--700 btn-hover--primary">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 mb-3 px-1">
                                <div class="customer-website-item position-relative text-center">
                                    <div
                                        class="item-description pos-abs-top-left bg-color--dark--1 w-100 h-100 d-flex align-items-center justify-content-center flex-column p-2">
                                        <h1 class="font-size--26 color--white mb-1">BuilderPro</h1>
                                        <p class="mb-3 color--white opacity--80">Finding the perfect learning tool for
                                            Flash is a daunting task to any novice web developer.</p>
                                        <a href="#"
                                            class="btn btn-size--sm rounded--none btn-border btn-border--color--light color--white btn-hover--primary">
        ...
        <div class="container pt-10">
            <div class="row align-items-center">
                <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0 mx-md-auto mx-lg-0 text-center text-lg-left reveal">
                    ...
                    <p class="mb-5">Over 44,306 people and businesses have come to us for their websites. Read their
                        reviews of SpaceMax to learn how great website changed their world.</p>
                    ...
                    <div class="carosuel-slider--v2 bg-white box-shadow--5 p-3 py-lg-5 pl-lg-4 pr-lg-10">
                        <div class="slide">
                            ...
                            <div class="position-relative z-index1 pt-2">
                                <span
                                    class="pos-abs-top-left testimonial__quote mr-3 font-size--30 opacity--10 z-index-1"><i
                                        class="icon icon-quote-2"></i></span>
                                <blockquote class="blockquote font-size--17">This process was so easy and quick. I'm so
                                    glad we were referred to this program. If we had gone the traditional route we would
                                    have spent much more and would have been limited one design ideas/interpretation.
                                    Extremely
    ...
    <section class="space">
        <div class="container">
            <div
                class="row pb-7 flex-column-reverse flex-lg-row-reverse align-items-center text-center justify-content-between">
                <div class="col-12 col-md-10 col-lg-6 col-xl-5 d-lg-block text-lg-left mt-9 mt-lg-6 reveal">
                    ...
                    <p class="mb-4">Create a free website that looks exactly the way you want. With our website builder,
                        you get beautiful galleries, professional image collections, secure hosting, personalized domains,
                        the best SEO and so much more.</p>
                    <a href="#"
                        class="btn btn-size--md rounded--none btn-border btn-border--color--dark text-color--700 btn-hover--primary">
                        <span class="btn__text font-w--500">Get Started Now</span>
                    </a>
            ...
            <div
                class="row mt-lg-10 flex-column-reverse flex-lg-row align-items-center text-center justify-content-between">
                <div class="col-12 col-md-10 col-lg-6 col-xl-5 d-lg-block text-lg-left mt-6 mt-lg-6 reveal">
                    ...
                    <p class="mb-4">Our all-in-one platform gives you everything you need to run your business. Whether
                        you’re just getting started or are an established brand, our powerful platform helps your business
                        grow.
                        <br>
                        <br> We provide you with a comprehensive set of marketing tools to engage with your audience.
                    </p>
                    <a href="#"
                        class="btn btn-size--md rounded--none btn-border btn-border--color--dark text-color--700 btn-hover--primary">
                        <span class="btn__text font-w--500">Get Started Now</span>
            ...
            <div class="row">
                <div class="col-12 col-lg-7 text-center mx-auto pb-8 reveal">
                    <div class="section-title">
                        ...
                        <p class="mb-4">Think of SpaceMax as your very own IT department, with free, unlimited hosting,
                            top-of-the-line security, an enterprise-grade infrastructure, and around-the-clock support. Get
                            personalized support from our Customer Care Team via
                            email or live chat, or join a live webinar. Reach out any time — we’re here 24/7.</p>
                        <a href="#" class="btn btn-bg--primary btn-size--md rounded--none btn-hover--3d"><span
                                class="btn__text font-w--500">Visit Help Center</span></a>
                    </div>
                </div>
            </div>
        </div>
